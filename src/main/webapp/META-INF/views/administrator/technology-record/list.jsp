...
<acme:list>
	...
	<acme:list-column code="administrator.technology-record.list.label.sector" path="sector" width="20%"/>
	<acme:list-column code="administrator.technology-record.list.label.title" path="title" width="30%"/>
