...
<acme:list>
	<acme:list-column code="administrator.tool-record.list.label.stars" path="stars" width="20%"/>
	<acme:list-column code="administrator.tool-record.list.label.sector" path="sector" width="20%"/>
