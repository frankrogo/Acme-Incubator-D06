...
@Service
public class BookkeeperInvestmentRoundListOthersService implements AbstractListService<Bookkeeper, InvestmentRound> {
	...
	public Collection<InvestmentRound> findMany(final Request<InvestmentRound> request) {
		...
		res = this.repository.findManyByNotMyBookkeeperId(principal.getActiveRoleId());
